...
const Catalogue = () => {
    const gencatalogue = () => {
        ...
        for (let i = 0; i < 100; i++){
            ...
            let columns = [["Category", "Gr Wt", "Net Wt", "D Wt", "D Pcs", "Stn Wt", "Stn Pcs", "BS Wt", "BS Pcs", "KT"]];
            let rows = [[111, 111, 111, 111, 111, 111 , 111, 111, 111, 111]];
            ...
            doc.autoTable({
                ...
                didDrawCell: async (data) => {
                  if (data.column.index === 1 && data.cell.section === 'body') {
                    ...
                    doc.text(`SKU No: ${111} , Design No: ${111}`, (pageWidth / 2), y + 75, 'center')
                  }
                }
              });
              y += 120;
              if (y >= pageHeight - 50 && i < 100 - 1) {
                doc.addPage();
                y = 20
                finalY = 40
            }
